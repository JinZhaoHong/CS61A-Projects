...
(define (list-partitions total max-pieces max-value)
  ; *** YOUR CODE HERE ***
  (define (helper so_far total max-pieces max-value)
    (cond ((= total 0) (list so_far))
      ((or (< total 0) (= max-pieces 0) (<= max-value 0)) '())
      (else (append 
        (helper (append so_far (list max-value)) (- total max-value) (- max-pieces 1) max-value)
        (helper so_far total max-pieces (- max-value 1))))))
