...
(begin (define a 'hello) (define b a) (display b) 'world)
; expect helloworld

;;; problem 8

(define a (lambda (b) (* b b) (+ b b)))
; expect a

a
; expect (lambda (b) (begin (* b b) (+ b b)))
...
(lambda ("helloworld") "Sandy")
; expect Error: not a well-formed list

(lambda (a b ''c) (* x y z) (e e))
; expect Error: not a well-formed list

(lambda (* x 'y z) (a b c))
; expect Error: not a well-formed list 

(lambda (John 'Ilove you) 9 (a b c))
; expect Error: not a well-formed list  
...
((lambda (x y z) (+ z (* x y) (* x z) (* y z))) 1 2 3)
;expect 14
...
(if #f 2 (if #t (if 1 2 3) 4))
; expect 2

(if (= 1 3) (/ 1 0) (if #t (* 3 4) (/ 15 5)))
; expect 12
...
(or (= 2 3) (= 3 4) (and 2 3 (or)) (or (and) (and)))
; expect True
...
(define (ordered? lst)
 (cond 
 ((equal? (cdr lst) nil) #t)
 ((and (> (car (cdr lst)) (car lst)) (empty? (cdr (cdr lst))) #t))
...
(define g (lambda (x y z) (f (+ x y z))))
; expect g

(g 1 2 3)
; expect 36

(define f (mu (x y z) (* x y z)))
; expect f

(define g (lambda (x y z) (f (+ x y z) 2 3)))
; expect g

(define h (lambda (x) (f (g x x x) 2 3)))
; expect h
